...
- A compact 20px banana coin inside the quota card turns slowly (12 seconds per revolution) during observed activity and gently bounces when clicked; separated from the pin, with no flyaway layer or additional window.
