...
assert.match(html,/<strong id="weeklyRemaining">—<\/strong><button id="quotaCoinButton"[^>]*aria-label="轻弹香蕉币"[^>]*><img class="quota-coin" src="\/shell\/assets\/monkex-coins-2026-09-07\/banana-coin-v1.png"/,'native keyboard-accessible coin button belongs inside quota');
...
assert.match(source,/\$\("quotaCoinButton"\)\.onclick=playQuotaCoin/);
